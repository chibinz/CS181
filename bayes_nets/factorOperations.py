...
def joinFactors(factors):
    ...
    unconditioned = set(
        [v for f in factors for v in f.unconditionedVariables()])
    conditioned = set(
        [v for f in factors for v in f.conditionedVariables() if v not in unconditioned])
    result = Factor(unconditioned, conditioned,
